...
<?php
$tb_cucisatuan = mysqli_query($connect, "select * from cucisatuan where ket='Belum Diambil'");

while ($array_tb_cucisatuan = mysqli_fetch_array($tb_cucisatuan, mysqli_assoc)) {
echo "
		<tr>
...
<?php
$tb_cucikilo = mysqli_query($connect, "select * from cucikilo where ket='Belum Diambil'");

// require_once('confirm_lunas.php'); // untuk konfirmasi lunas

while ($array_tb_cucikilo = mysqli_fetch_array($tb_cucikilo, mysqli_assoc)) {
echo "
		<tr>
